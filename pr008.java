...
class VarArgs {
	...
	static void vaTest2(String msg, int ... v) {
		...
		System.out.println("Содержание массива аргументов: ");
		for(int i=0; i<v.length; i++)
			System.out.println("аргумент" + i + ":" + v[i]);
		System.out.println():
	}
	static void vaTest3( int ... v) {
	 ...
	 static void vaTest3(boolean, int ... v) {
         ...
         static void vaTest3(Sting msg, int ... v) {
                System.out.println("vaTest3(String, int...)" + "Количество аргументов" + v.length);
                System.out.println("Содержание массива аргументов: ");
  ...
  public static void main(String[] args) {
    ...
    //Сдвиг влево значения 1
		...
		for(byte b=0; b<10; b++) {
      			...
      			System.out.pri(b + " в двоичном виде: ");
      			byteval.show(b);
		 }

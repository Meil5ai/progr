	...
	void helpOn(int what){
		switch(what) {
			...
			case '3':
				...
				System.out.println("for (инициализация; yslovie;enercheya");
				System.out.println(" оператор;");
				break;
			case '4':
				System.out.println("Chikl while:\n");
				System.out.println("while (условие) оператор;");
				break;
			case '5':
				System.out.println("Chikl do-while:\n");
...
class HelpClassDemo {
	public static void main(String args[]) throws java.to.IOException {
		char choice, ignore;
